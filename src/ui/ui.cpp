...
static lv_obj_t *blindsGroupContainer;
...
void ui_init(void)
{
    ...
    blindsGroupContainer = lv_obj_create(screen);
...
static void add_button(lv_obj_t *btn_cont, const char *t, blinds_button_t button, void *user_data)
{
...
void create_blinds(const char *label_text, blinds_button_callback_t callback, void *user_data)
{
    ...
    // Buttons
    add_button(btn_cont, LV_SYMBOL_DOWN, DOWN, user_data);
    add_button(btn_cont, LV_SYMBOL_STOP, STOP, user_data);
    add_button(btn_cont, LV_SYMBOL_UP, UP, user_data);
